# Согласно варианту №3 требуется написать программу, которая в одномерном массиве, состоящем из n вещественных элементов вычислит сумму отрицательных элементов и произведение элементов массива,
